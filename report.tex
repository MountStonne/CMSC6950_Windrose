...
After adding the contours, the wind rose was visualized better.
 ...
 \chapter{Conclusion}
 The graph results shows that more than 50 percent wind in St. John's is from northwest and southeast. The maximum wind is in the last year is m/s, while the minimum wind is m/s. The wind direction and speed may change with season changed which will be explored in the future studies.
